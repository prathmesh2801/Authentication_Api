...
class DeleteUserView(APIView):
    ...
    def delete(self, request):
        ...
        try:
            ...
            user.deletion_date = timezone.now() + timezone.timedelta(days=30)  # Set deletion date
            user.save()

            return Response({"message": "User marked for deletion. It will be permanently deleted after 30 days."})
